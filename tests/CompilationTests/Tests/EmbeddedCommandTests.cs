...
namespace Brighid.Commands.Sdk.CompilationTests
{
    ...
    {
        private const string ProjectPath = "CompilationTests/Projects/EmbeddedCommand/EmbeddedCommand.csproj";
        ...
        public async Task RegisterShouldReturnCommandRunner()
        {
            ...
            var registratorType = assembly.GetType("Brighid.Commands.Sdk.CompilationTests.EmbeddedCommand.TestCommandRegistrator");
